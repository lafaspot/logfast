...
/**
 * Logger is a implementation to be used in multi-threaded application. The main goal of this Logger
 * is to reduce log contention between threads and be fast. This class is not thread safe by design.
 *
 * @author lafa
 */
@NotThreadSafe
public class Logger {
  ...
  public void error(final Object data, final Exception cause) {
    log(Logger.ERRORINT, data, cause);
  }

  public void warn(final Object data, final Exception cause) {
    log(Logger.WARNINT, data, cause);
  }

  public void info(final Object data, final Exception cause) {
    log(Logger.INFOINT, data, cause);
  }

  public void debug(final Object data, final Exception cause) {
    log(Logger.DEBUGINT, data, cause);
  }

  public void fatal(final Object data, final Exception cause) {
    log(Logger.FATALINT, data, cause);
  }

  public void trace(final Object data, final Exception cause) {
    log(Logger.TRACEINT, data, cause);
  }

  private void log(final int level, final Object data, final Exception cause) {
    if (level <= curLevel && context != null && data != null) {
      rotate();
      if (legacy) {
        logger.debug(context.toString() + " " + data.toString(), cause);
      }
      pages[active].log(context, level, data, cause, isDumpStackOn);
    }
  }
